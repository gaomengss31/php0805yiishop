    ...
    <div class="nav w1210 bc mt10">
        ...
        <div class="category fl"> <!-- 非首页，需要添加cat1类 -->
            ...
            <div class="cat_bd">
                ...
                <div class="cat item1">
                    <h3><a href="goods/list?goods_category_id=<?=$model->id?>"><?=$model->name?></a></h3>
                    <!--http://www.yiishop.com/goods/list?goods_category_id=4-->
                    <div class="cat_detail">
                        <?php foreach($model->children as $child):?>
                        <dl class="dl_1st">
                            <dt><a href="goods/list?goods_category_id=<?=$child->id?>"><?=$child->name?></a></dt>
                            <?php foreach($child->children as $child1):?>
                            <dd>
                                <a href="goods/list?goods_category_id=<?=$child1->id?>"><?=$child1->name?></a>
                            </dd>
                            <?php endforeach;?>
                        </dl>
                        <?php endforeach;?>
